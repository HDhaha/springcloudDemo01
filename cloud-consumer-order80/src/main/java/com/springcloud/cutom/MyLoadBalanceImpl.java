...
//public class MyLoadBalanceImpl implements ReactorServiceInstanceLoadBalancer {
...
//    public MyLoadBalanceImpl(ObjectProvider<ServiceInstanceListSupplier> serviceInstanceListSupplierProvider,
//                             String serviceId) {
//        //如果不传人请求次数就自己初始化 反正每次都+1
//        this(new Random().nextInt(1000), serviceId,serviceInstanceListSupplierProvider);
//    }
//
//    public MyLoadBalanceImpl(int seedPosition, String serviceId, ObjectProvider<ServiceInstanceListSupplier> serviceInstanceListSupplierProvider) {
